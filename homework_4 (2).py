...
# text = ['dfgh', 'rtyu','Astana','Moskow','osh','Mers','Lexus','Bmw','Bud','jag','rssv','sadfdsd','tesla','Google','Amazon']
# print(text[2:7])
...
# numbers = [1, 2, 3, 4, 5, 6, 7]
# nums = sum(numbers) / len(numbers)
# print(nums)

# text = ['saddA', 'rtyu','Astana','Moskow','KUKU','Mers','Lexus','Bmw','Bud','JAG']
# text[4], text[8] = text[8], text[4]
# print(text)
